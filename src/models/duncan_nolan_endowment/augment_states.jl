"""
```
augment_states{T<:AbstractFloat}(m::DuncanNolanEndowment, TTT::Matrix{T}, RRR::Matrix{T}, CCC::Matrix{T})
```
...
"""
function augment_states{T<:AbstractFloat}(m::DuncanNolanEndowment, TTT::Matrix{T}, RRR::Matrix{T}, CCC::Vector{T})
    return TTT, RRR, CCC
end
