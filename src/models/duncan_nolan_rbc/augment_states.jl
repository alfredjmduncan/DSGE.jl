"""
```
augment_states{T<:AbstractFloat}(m::DuncanNolanRBC, TTT::Matrix{T}, RRR::Matrix{T}, CCC::Matrix{T})
```
...
"""
function augment_states{T<:AbstractFloat}(m::DuncanNolanRBC, TTT::Matrix{T}, RRR::Matrix{T}, CCC::Vector{T})
    return TTT, RRR, CCC
end
